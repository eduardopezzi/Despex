...
export class OcrProcessor extends WorkerHost {
    ...
    async process(job: Job<{ invoiceId: number }>): Promise<void> {
        ...
        try {
            ...
            const mimeType = OcrProcessor.getMimeType(path.extname(invoice.filename).toLowerCase());
            ...
            await this.invoicesDao.updateStatus(invoiceId, InvoiceStatus.Completed, JSON.stringify(response.data));
